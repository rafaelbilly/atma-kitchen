      ...
      <div className="2xl:container 2xl:mx-auto md:py-12 md:px-6 py-9 px-4">
        <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 items-center justify-center">
          <div className="w-full lg:w-6/12">
            <h2 className="w-full font-black lg:text-4xl text-3xl lg:leading-10 leading-9 text-primary">
              We are here to make delicious cake and delightfull for everyone
            </h2>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              The bakery's journey has been marked by milestones and
              achievements, including winning prestigious awards and recognition
              for its outstanding contributions to the culinary world. Despite
              its growth and success, Atma Kitchen remains rooted in its values
              of passion, integrity, and community engagement, making it a
              cherished bakery for generations to come.
            </p>
          </div>
          <div className="w-full lg:w-6/12">
            <img
              className="lg:block hidden w-full"
              src="https://plus.unsplash.com/premium_photo-1687904384427-d5e770bd644f?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
        ...
        <div className="grid sm:grid-cols-3 grid-cols-2 sm:gap-8 gap-4">
          <div>
            <p className="font-bold lg:text-2xl text-xl lg:leading-6 leading-5 text-primary mt-6">
              Inspiration and Creation
            </p>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              Our team of passionate bakers draws inspiration from a variety of
              sources, including traditional recipes, innovative techniques, and
              the latest culinary trends. We carefully select the finest
              ingredients, ensuring that each creation is of the highest
              quality.
            </p>
          </div>
          <div>
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              We believe that the key to a memorable bakery experience lies in
              the details. Our bakers pay close attention to every aspect of the
              baking process, from mixing and kneading to proofing and baking.
            </p>
          </div>
          <div className="sm:block hidden">
            ...
            <p className="font-normal text-base leading-6 text-gray-600 mt-6">
              We value the relationships we have with our customers, suppliers,
              and community. We strive to create a warm and welcoming atmosphere
              where everyone feels like part of the family. Through events,
              workshops, and collaborations, we foster a sense of connection and
              belonging.
            </p>
          </div>
        </div>
        ...
        <div className="flex lg:flex-row flex-col md:gap-14 gap-16 justify-between lg:mt-20 mt-16">
          <div className="w-full lg:w-6/12">
            <h2 className="font-black lg:text-4xl text-3xl lg:leading-9 leading-7 text-primary">
              Our Mission
            </h2>
            <p className="font-normal text-base leading-6 text-gray-600 mt-6 w-full lg:w-10/12 xl:w-9/12">
              Our mission is to delight our customers with exceptional baked
              goods while fostering a sense of community and promoting
              sustainable practices. We are committed to delivering baked goods
              of the highest quality, using premium ingredients, time-honored
              techniques, and innovative recipes to ensure a memorable culinary
              experience. Customer satisfaction is our priority, and we
              continuously improve our products and services based on feedback.{" "}
              <br /> <br />
              We also believe in building strong relationships with our
              community, supporting local initiatives, and creating a welcoming
              space for people to gather, connect, and share moments of joy.
              Sustainability is at the core of our operations, from responsible
              ingredient sourcing to waste reduction and resource conservation.
              We embrace creativity and innovation in our baking processes, menu
              development, and customer experiences, empowering our team members
              to grow and excel.
            </p>
          </div>
          <div className="w-full lg:w-6/12">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 lg:gap-12 gap-10">
              <div className="flex p-4 shadow-md">
                ...
                <div className="">
                  <p className="font-bold lg:text-2xl text-xl lg:leading-6 leading-5 text-primary">
                    Team
                  </p>
